package com.example.projectsisir.service.util;
...
public class PdfUtil {
    ...
    public static HttpEntity<byte[]> createPdf(String fileName, String templatePath, Map<String, String > data, Map<String,Integer> daja ,Map<String,Double> dada) throws IOException {
        ...
        daja.forEach((y, z) -> context.put(y, z));
        dada.forEach((y, z) -> context.put(y, z));
